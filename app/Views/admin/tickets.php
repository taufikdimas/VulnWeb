            ...
            <div class="row g-3">
                ...
                <div class="col-lg-1 col-md-1">
                    <button type="button"
                            ...
                            onclick="window.location.href='index.php?controller=admin&action=tickets'"
                            title="Clear Filters">
            ...
            <div class="table-responsive">
                <table class="table table-modern mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="priority-<?php echo $ticket['priority'] ?>" onclick="window.location.href='index.php?controller=admin&action=viewTicket&id=<?php echo $ticket['id'] ?>'">
                            <td>
                                <strong class="text-primary">#<?php echo $ticket['id'] ?></strong>
                            </td>
                            <td>
                                <strong class="text-dark"><?php echo htmlspecialchars($ticket['subject']) ?></strong>
                            </td>
                            <td>
                                <div>
                            ...
                            <td>
                                <span class="badge bg-<?php echo $statusColors[$ticket['status']] ?>" style="font-size: 0.75rem; padding: 0.4rem 0.75rem;">
                                    <?php echo strtoupper(str_replace('_', ' ', $ticket['status'])) ?>
                                </span>
                            </td>
                            <td>
                                <span class="badge bg-<?php echo $priorityColors[$ticket['priority']] ?>" style="font-size: 0.75rem; padding: 0.4rem 0.75rem;">
                                    <i class="bi bi-flag-fill"></i> <?php echo ucfirst($ticket['priority']) ?>
                                </span>
                            </td>
                            <td>
                                <span class="badge bg-light text-dark border" style="font-size: 0.75rem; padding: 0.4rem 0.75rem;">
