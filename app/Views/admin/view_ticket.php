...
<div class="container-fluid">
    <!-- Back Button -->
    <div class="mb-3">
        <a href="index.php?controller=admin&action=tickets" class="btn btn-outline-secondary">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="ticket-body">
                ...
                <div class="mt-3">
                    ...
                    <a href="index.php?controller=admin&action=getTicketAttachment&id=<?php echo $ticket['id'] ?>"
                       target="_blank"
                    ...
                    ?>
                        <div class="mt-3">
                            <img src="index.php?controller=admin&action=getTicketAttachment&id=<?php echo $ticket['id'] ?>"
            ...
            <div class="comment-section">
                ...
                <?php else: ?>
                    <?php foreach ($comments as $comment): ?>
                        <div class="comment-item <?php echo $comment['is_internal'] ? 'internal-note' : '' ?>">
                ...
                <div class="reply-form">
                    ...
                    <form method="POST" action="index.php?controller=admin&action=addComment">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="internal">
                                <i class="bi bi-eye-slash"></i> Internal Note (Not visible to user)
                            </label>
                        </div>
                ...
                <div class="alert alert-info">
                    <i class="bi bi-info-circle"></i> This ticket is closed. Reopen it to add more replies.
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="admin-actions">
                ...
                <!-- Status -->
                <form method="POST" action="index.php?controller=admin&action=updateTicketStatus" class="mb-3">
                    <input type="hidden" name="ticket_id" value="<?php echo $ticket['id'] ?>">
                ...
                <!-- Priority -->
                <form method="POST" action="index.php?controller=admin&action=updateTicketPriority" class="mb-3">
                    <input type="hidden" name="ticket_id" value="<?php echo $ticket['id'] ?>">
                ...
                <!-- Category -->
                <form method="POST" action="index.php?controller=admin&action=updateTicketCategory" class="mb-3">
                    <input type="hidden" name="ticket_id" value="<?php echo $ticket['id'] ?>">
                    ...
                    <select name="category" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="access" <?php echo $ticket['category'] == 'access' ? 'selected' : '' ?>>Access</option>
                        <option value="email" <?php echo $ticket['category'] == 'email' ? 'selected' : '' ?>>Email</option>
                        <option value="other" <?php echo $ticket['category'] == 'other' ? 'selected' : '' ?>>Other</option>
                    </select>
                </form>

                <!-- Assignment -->
                <form method="POST" action="index.php?controller=admin&action=assignTicket" class="mb-3">
                    <input type="hidden" name="ticket_id" value="<?php echo $ticket['id'] ?>">
